...
urlpatterns = [
    ...
    path("organizations/<int:org_id>/memberships/" , OrganizationMembershipListCreateView.as_view() , name="org-membership-list"),
    path("organizations/<int:org_id>/memberships/<int:pk>/" , OrganizationMembershipDetailView.as_view() , name="org-membership-detail")
]